    ...
    private void onChangeEvent() {
        sp.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                if (!"Time Length".equals(sp.getSelectedItem().toString())){
                    if ("<30 mins".equals(sp.getSelectedItem().toString())){
                        low = 0;
                        high = 30;
                    }
                    else if ("30-60 mins".equals(sp.getSelectedItem().toString())){
                        low = 30;
                        high = 60;
                    }
                    else if ("1-2 hrs".equals(sp.getSelectedItem().toString())){
                        low = 60;
                        high = 120;
                    }
                    else if (">2 hrs".equals(sp.getSelectedItem().toString())){
                        low = 120;
                        high = 4320;
                    }
